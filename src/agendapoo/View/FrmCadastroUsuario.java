...
public class FrmCadastroUsuario extends javax.swing.JFrame
{
    ...
    private void setFrameIcon(){
        ImageIcon icon = new ImageIcon("src//agendapoo//imgs//Light_Add_user.png");
    ...
    private void cadastraUsuario(){
        ...
        try
        {
            control.cadastraUsuario(nome, email, senha, telefone, dataNascimento);
            cleanFields();
            JOptionPane.showMessageDialog(this, "Usuário cadastro com sucesso! Bem Vindo, "+nome+"! :)");
            this.dispose();
        }
        catch(SQLException | IOException | ClassNotFoundException | EmailJaCadastradoException ex){
            JOptionPane.showMessageDialog(this, ex.getMessage(),"ERROR",JOptionPane.ERROR_MESSAGE);
        }
        catch(DateTimeParseException dtpe){
            JOptionPane.showMessageDialog(this, "Insira uma data de nascimento válida! \nSeguindo a formatação [Dia/Mês/Ano].", "Data de Nascimento inválida", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void initComponents()
    {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/agendapoo/imgs/User_3-128.png"))); // NOI18N
