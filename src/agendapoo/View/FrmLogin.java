...
public class FrmLogin extends javax.swing.JFrame
{
    ...
    private Usuario logIn(ControlSistema login) throws SQLException, IOException, ClassNotFoundException, UsuarioNaoExistenteException{
    ...
    private void initComponents()
    {
        ...
        btnLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/agendapoo/imgs/sign_in.png"))); // NOI18N
        ...
        jLabelLoginIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/agendapoo/imgs/login-icon.png"))); // NOI18N
    ...
    {//GEN-HEADEREND:event_btnLoginActionPerformed
        if(!isThereEmptyFields()){
            try
            {
                ControlSistema login = new ControlSistema();
            ...
            catch(SQLException | IOException | ClassNotFoundException | UsuarioNaoExistenteException ex){
