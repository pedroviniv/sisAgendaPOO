...
public class FrmMinhaAtividade extends javax.swing.JFrame
{
    ...
    private void deleteAtividade() throws SQLException, IOException{
        ControlAtividade ca = new ControlAtividade();
        ca.removeAtividade(selectedAtividade);
    }
    ...
    private void saveChanges(Atividade a) throws SQLException, IOException{
        List<String> lista = new ArrayList<>();
        for(String email : getStringListFromListModel()){
            lista.add(email);
            System.out.println("Object to: "+email);
        }
        selectedAtividade.setConvidao(lista);
        ...
        System.out.println(selectedAtividade);
        ControlAtividade ca = new ControlAtividade();
    ...
    private void initComponents()
    {
        ...
        btnRemoveConvidado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/delete.png"))); // NOI18N
        ...
        btnAddConvidado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/add_16.png"))); // NOI18N
        ...
        btnSaveChanges.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/002_10.png"))); // NOI18N
        ...
        btnUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/File-edit-icon.png"))); // NOI18N
        ...
        btnRemove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/Delete-icon.png"))); // NOI18N
        ...
        btnCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisagendapoo/imgs/Users-Exit-icon (1).png"))); // NOI18N
